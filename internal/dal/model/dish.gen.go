...
type Dish struct {
	...
	Name        string    `gorm:"column:name;type:varchar(32);not null;comment:菜品名称" json:"name"`            // 菜品名称
	CategoryID  int64     `gorm:"column:category_id;type:bigint;not null;comment:菜品分类id" json:"category_id"` // 菜品分类id
	Price       float64   `gorm:"column:price;type:decimal(10,2);comment:菜品价格" json:"price"`                 // 菜品价格
	...
	Status      int32     `gorm:"column:status;type:int;default:1;comment:0 停售 1 起售" json:"status"`          // 0 停售 1 起售
